"""SETTING_SPECS-Permalink-Muster, Presets und Zufalls-Seed-Button (Standardmuster aus dem Demo-Portfolio, siehe rf_presets.py in random-forest-demo)."""
...
def _bool(value):
    ...
    if value in ("1", "true", "ja"):
        return True
    if value in ("0", "false", "nein"):
        return False
    raise ValueError(value)
...
SETTING_SPECS = {
    ...
    "bootstrap_check": SettingSpec("boot", _bool, C.DEFAULT_BOOTSTRAP),
...
PRESET_KEYS = {"task": "task_select", "leaf": "leaf_slider", "n_trees": "n_trees_slider", "mtry": "mtry_slider", "bootstrap": "bootstrap_check", "n": "n_slider", "n_noise": "n_noise_slider",
